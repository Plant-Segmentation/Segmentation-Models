...
flags.DEFINE_string('vis_logdir', 'vis_mobilenet/', 'Where to write the event logs.')

flags.DEFINE_string('checkpoint_dir', 'checkpoints_mobilenet/', 'Directory of model checkpoints.')
...
flags.DEFINE_list('vis_crop_size', '901,901',
...
flags.DEFINE_enum('colormap_type', 'category4', ['pascal', 'cityscapes', 'category4'],
...
# The format to save the ground truth mask
_GT_FORMAT = '%06d_gt'
...
def _process_batch(sess, original_images, semantic_predictions, gt_labels, image_names,
                   image_heights, image_widths, image_id_offset, update_op, iou, save_dir,
                   raw_save_dir, utf, mtf, train_id_to_eval_id=None):

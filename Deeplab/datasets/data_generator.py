...
_PLANT_CATEGORY4_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 117,
        #'train': 183,  # num of samples in images/training
        'trainval': 12,  # num of samples in images/validation
        #'traintest': 127,
    },
    num_classes=4,
    ignore_label=255,
...
class Dataset(object):
  ...
  def __init__(self,
    ...
    print("splits to sizes: ", splits_to_sizes)
    print("data split: ", split_name)

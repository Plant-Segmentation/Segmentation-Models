...
flags.DEFINE_multi_float('eval_scales', 1, #[0.75, 1.0, 1.25],
                         'The scales to resize images for evaluation.')

# Change to True for adding flipped images during test.
flags.DEFINE_bool('add_flipped_images', False, #True,
...
_SEMANTIC_PREDICTION_SAVE_FOLDER1 = 'results'
...
_LABEL_SEMANTIC_PREDICTION_SAVE_FOLDER='segmentation_labels'

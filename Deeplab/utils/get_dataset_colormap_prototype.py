...
def create_plant_category4_colormap():
  """Creates a label colormap used in Plant Category4 segmentation benchmark.
  ...
  colormap[1] = [128, 0, 0] #stem #14
  colormap[2] = [0, 0, 128] #callus #38
  colormap[3] = [0, 128, 0] #shoot #75
  return colormap
